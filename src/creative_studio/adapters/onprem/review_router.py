...
never let a consequential creative result bypass human review (P-06, rule R8), so porting
on-premise *must* supply a real hand-off to the sovereign review console. Filling this body in is
