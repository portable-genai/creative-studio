...
def build_spec() -> PluginSpec:
    ...
    from creative_studio.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from creative_studio.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/creative-studio",
        ...
        servers={
            "creative-studio": StdioServer(
                command="python",
                args=("-m", "creative_studio.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
